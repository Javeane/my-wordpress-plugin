...
?>
    <div class="social-login-provider">
        <label for="my_wp_plugin_social_login_google_client_id"><?php esc_html_e('Client ID', 'my-wp-plugin'); ?></label>
        <input type="text" id="my_wp_plugin_social_login_google_client_id" name="my_wp_plugin_social_login_google[client_id]" value="<?php echo esc_attr($google_client_id); ?>">
    </div>
    <div class="social-login-provider">
        <label for="my_wp_plugin_social_login_google_client_secret"><?php esc_html_e('Client Secret', 'my-wp-plugin'); ?></label>
        <input type="text" id="my_wp_plugin_social_login_google_client_secret" name="my_wp_plugin_social_login_google[client_secret]" value="<?php echo esc_attr($google_client_secret); ?>">
    </div>
<?php
}
...
function my_wp_plugin_social_login_tiktok_callback() {
    $tiktok_client_id = get_option('my_wp_plugin_social_login_tiktok')['client_id'] ?? '';
    $tiktok_client_secret = get_option('my_wp_plugin_social_login_tiktok')['client_secret'] ?? '';
    ?>
    <div class="social-login-provider">
        <label for="my_wp_plugin_social_login_tiktok_client_id"><?php esc_html_e('Client ID', 'my-wp-plugin'); ?></label>
            <input type="text" id="my_wp_plugin_social_login_tiktok_client_id" name="my_wp_plugin_social_login_tiktok[client_id]" value="<?php echo esc_attr($tiktok_client_id); ?>">
    </div>
    <div class="social-login-provider">
        <label for="my_wp_plugin_social_login_tiktok_client_secret"><?php esc_html_e('Client Secret', 'my-wp-plugin'); ?></label>
            <input type="text" id="my_wp_plugin_social_login_tiktok_client_secret" name="my_wp_plugin_social_login_tiktok[client_secret]" value="<?php echo esc_attr($tiktok_client_secret); ?>">
    </div>
<?php
}
add_action('my_wp_plugin_social_login_tiktok', 'my_wp_plugin_social_login_tiktok_callback');

function my_wp_plugin_social_login_twitter_callback() {
    $twitter_api_key = get_option('my_wp_plugin_social_login_twitter')['api_key'] ?? '';
    $twitter_api_secret_key = get_option('my_wp_plugin_social_login_twitter')['api_secret_key'] ?? '';
    ?>
    <div class="social-login-provider">
        <label for="my_wp_plugin_social_login_twitter_api_key"><?php esc_html_e('API Key', 'my-wp-plugin'); ?></label>
            <input type="text" id="my_wp_plugin_social_login_twitter_api_key" name="my_wp_plugin_social_login_twitter[api_key]" value="<?php echo esc_attr($twitter_api_key); ?>">
    </div>
    <div class="social-login-provider">
        <label for="my_wp_plugin_social_login_twitter_api_secret_key"><?php esc_html_e('API Secret Key', 'my-wp-plugin'); ?></label>
            <input type="text" id="my_wp_plugin_social_login_twitter_api_secret_key" name="my_wp_plugin_social_login_twitter[api_secret_key]" value="<?php echo esc_attr($twitter_api_secret_key); ?>">
    </div>
<?php
}
add_action('my_wp_plugin_social_login_twitter', 'my_wp_plugin_social_login_twitter_callback');

function my_wp_plugin_social_login_facebook_callback() {
    $facebook_app_id = get_option('my_wp_plugin_social_login_facebook')['app_id'] ?? '';
    $facebook_app_secret = get_option('my_wp_plugin_social_login_facebook')['app_secret'] ?? '';
    ?>
    <div class="social-login-provider">
        <label for="my_wp_plugin_social_login_facebook_app_id"><?php _e('App ID:', 'my-wp-plugin'); ?></label>
            <input type="text" id="my_wp_plugin_social_login_facebook_app_id" name="my_wp_plugin_social_login_facebook[app_id]" value="<?php echo $facebook_app_id; ?>">
        <label for="my_wp_plugin_social_login_facebook_app_secret"><?php _e('App Secret:', 'my-wp-plugin'); ?></label>
            <input type="text" id="my_wp_plugin_social_login_facebook_app_secret" name="my_wp_plugin_social_login_facebook[app_secret]" value="<?php echo $facebook_app_secret; ?>">
    </div>
<?php
}

add_action('my_wp_plugin_social_login_facebook', 'my_wp_plugin_social_login_facebook_callback');
...
public function custom_avatar_settings_callback() {
    ...
    <form method="post" action="options.php">
        <?php settings_fields( 'custom_avatar_options' ); ?>
        <?php do_settings_sections( 'custom_avatar_options' ); ?>
        <p><?php esc_html_e( 'Choose whether users can upload their own custom avatar or use the default avatar provided by the site.', 'my-textdomain' ); ?></p>
        <?php
        ...
        ?>
        <label for="custom-avatar-option-default"><input type="radio" name="custom_avatar_option" id="custom-avatar-option-default" value="default" <?php echo $checked_default; ?> /> <?php esc_html_e( 'Use default avatar provided by the site', 'my-textdomain' ); ?></label><br />
        <label for="custom-avatar-option-custom"><input type="radio" name="custom_avatar_option" id="custom-avatar-option-custom" value="custom" <?php echo $checked_custom; ?> /> <?php esc_html_e( 'Allow users to upload their own custom avatar', 'my-textdomain' ); ?></label>
        <?php submit_button(); ?>
    </form>
    <?php
    }
...
public function save_custom_avatar_field( $user_id ) {
    ...
    if ( isset( $_FILES['custom_avatar'] ) ) {
        update_user_meta( $user_id, 'custom_avatar', sanitize_text_field( $_FILES['custom_avatar']['name'] ) );
    } else {
...
public function custom_avatar_field( $user ) {
    $custom_avatar = get_user_meta( $user->ID, 'custom_avatar', true );
    ?>
    <h3><?php esc_html_e( 'Custom Avatar', 'myplugin' ); ?></h3>
    <table class="form-table">
        <tr>
            <th><label for="custom_avatar"><?php esc_html_e( 'Avatar URL', 'myplugin' ); ?></label></th>
            <td>
                <input type="text" name="custom_avatar" id="custom_avatar" value="<?php echo esc_attr( $custom_avatar ); ?>" class="regular-text" /><br />
                <span class="description"><?php esc_html_e( 'Enter the URL of your custom avatar image.', 'myplugin' ); ?></span>
            </td>
        </tr>
    </table>
    <?php
...
public function enqueue_media_uploader() {
    wp_enqueue_media();
    wp_enqueue_script( 'myplugin-media-uploader', plugin_dir_url( __FILE__ ) . '/js/media-uploader.js', array( 'jquery' ), '1.0.0', true );
    }
...
public function save_custom_avatar_field_media_uploader( $user_id ) {
    ...
    if ( isset( $_POST['custom_avatar'] ) ) {
        update_user_meta( $user_id, 'custom_avatar', sanitize_text_field( wp_unslash( $_POST['custom_avatar'] ) ) );
    } elseif ( isset( $_POST['custom_avatar_attachment_id'] ) ) {
        update_user_meta( $user_id, 'custom_avatar', wp_get_attachment_url( intval( $_POST['custom_avatar_attachment_id'] ) ) );
    } else {
        delete_user_meta( $user_id, 'custom_avatar' );
        }
    }
...
public function custom_avatar_field_media_uploader( $user ) {
    ...
    <tr>
        ...
        <td>
            ...
            <button type="button" class="button button-secondary custom-avatar-upload"><?php _e( 'Upload Avatar', 'myplugin' ); ?></button>
            <button type="button" class="button custom-avatar-remove"><?php _e( 'Remove Avatar', 'myplugin' ); ?></button>
 ...
 */
    public function custom_avatar_field_media_uploader_scripts() {
        wp_enqueue_media();
        wp_enqueue_script( 'custom-avatar-field-media-uploader', plugin_dir_url( __FILE__ ) . 'js/custom-avatar-field-media-uploader.js', array( 'jquery' ), '1.0.0', true );
    }
